...
- `fabric-26.1` and `fabric-26.2-dev` (Minecraft 26.2) need **JDK 25**. For exact 26.1, use `build-and-deploy-26.1.sh` or set `JAVA_HOME=/opt/homebrew/opt/openjdk@25/libexec/openjdk.jdk/Contents/Home` when invoking Gradle.

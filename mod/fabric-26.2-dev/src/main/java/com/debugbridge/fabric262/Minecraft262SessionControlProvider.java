...
/**
 * Session control for 26.2. {@code disconnect} and {@code quit}
 ...
 *
 * <p>Written against the 1.21.x connect/disconnect API with the 26.x
 * {@code mc.gui.screen()} ownership model.
 */

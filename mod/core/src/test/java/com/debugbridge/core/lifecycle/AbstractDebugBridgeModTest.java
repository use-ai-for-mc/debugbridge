    ...
    static final class StubMod extends AbstractDebugBridgeMod {
        ...
        protected NearbyEntitiesProvider createEntitiesProvider() {
            return new NearbyEntitiesProvider() {
                @Override
                public List<com.debugbridge.core.protocol.dto.EntitySummaryDto>
                getNearbyEntities(double r, int l) {
                    return List.of();
                }
                
                @Override
                public com.debugbridge.core.protocol.dto.EntityDetailsDto
                getEntityDetails(int id) {
                    return null;
                }
            };
        }
        ...
        protected NearbyBlocksProvider createBlocksProvider() {
            return new NearbyBlocksProvider() {
                @Override
                public List<com.debugbridge.core.protocol.dto.BlockSummaryDto>
                getNearbyBlocks(double r, int l) {
                    return List.of();
                }
                
                @Override
                public com.debugbridge.core.protocol.dto.BlockDetailsDto
                getBlockDetails(int x, int y, int z) {
                    return null;
                }
            };
        }
